...
Usage: 
    PEPP_score_hyperopt_pair.py <curr_cat> <classifier> <scorfunc> <rep_size> <outer_size> <inner_size> <replab> <outerlab>
...
#Set output path.
outpath = ('pair_'+classifier+'_'+scorfunc+'_r'+rep_size+'_fo'+outer_size+'_fi'+inner_size+'/')
