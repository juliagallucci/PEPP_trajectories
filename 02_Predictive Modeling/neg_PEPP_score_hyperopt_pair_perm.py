...
Usage: 
    neg_PEPP_score_hyperopt_pair_perm.py <curr_cat> <classifier> <scorfunc> <rep_size> <outer_size> <inner_size> <replab> <outerlab> <nperm> <permidx>
...
inpath = ('pair_neg_'+classifier+'_'+scorfunc+'_r'+rep_size+'_fo'+outer_size+'_fi'+inner_size+'/')
savelab = 'hyper'
...
#Set output path.
outpath = ('pair_neg_'+classifier+'_'+scorfunc+'_r'+rep_size+'_fo'+outer_size+'_fi'+inner_size+'/perm/')
